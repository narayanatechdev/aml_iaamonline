...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_JOURNAL_DATA: process.env.NEXT_PUBLIC_JOURNAL_DATA || '',
    NEXT_PUBLIC_JOURNAL_CURRENT_VOLUME: process.env.NEXT_PUBLIC_JOURNAL_CURRENT_VOLUME || '',
    NEXT_PUBLIC_JOURNAL_CURRENT_ISSUE: process.env.NEXT_PUBLIC_JOURNAL_CURRENT_ISSUE || '',
