  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto px-6 py-10">
        {/* Breadcrumb */}
        <Breadcrumb 
          items={[{ label: 'Browse', href: '/browse' }, { label: 'Archive' }]} 
          className="mb-6"
        />
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="border-b border-gray-200 pb-5">
              <h3 className="text-[#0f2d6b] text-base font-semibold mb-4">Browse by Year & Volume</h3>
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {ARCHIVE_VOLUMES.map((yearData) => (
                  <div key={yearData.year}>
                    ...
                    >
                      <span className="text-[#0f2d6b] text-base font-medium">{yearData.year}</span>
          ...
          <div className="lg:col-span-3">
            {!selectedVolumeIssue ? (
              <div className="py-10 text-center border-b border-gray-200">
                <h1 className="text-[#0f1a2e] text-2xl font-bold mb-4">Browse Journal Archive</h1>
              ...
              <div>
                ...
                <div className="border-b border-gray-200 pb-6 mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h1 className="text-[#0f1a2e] text-2xl font-bold">
                ...
                <div className="">
                  {selectedArticles.length > 0 ? (
                    ...
                    <div className="py-10 text-center border-b border-gray-200">
                      <p className="text-[#5a6a8a] text-base">No articles found for this volume.</p>
                    </div>
                  )}
                </div>
              </div>
