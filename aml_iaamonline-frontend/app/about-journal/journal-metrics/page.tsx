        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl border border-gray-100 p-6 text-center">
              ...
              <div className="text-2xl font-bold text-[#0f2d6b] mb-1">2010</div>
              <div className="text-sm text-gray-600">Publishing Since</div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-8 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Journal Indicators</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600">First Published:</span>
                    <span className="text-gray-900 font-bold text-lg">2010</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600">Articles Published:</span>
                    <span className="text-gray-900 font-bold">2,000+</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    <span className="text-gray-600">Author Countries:</span>
                    <span className="text-gray-900 font-bold">75+</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-600">h-index (Google Scholar):</span>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <span className="text-gray-700">Total Volumes</span>
                    <span className="text-gray-900 font-semibold">17</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <span className="text-gray-700">Publishing Since</span>
                    <span className="text-gray-900 font-semibold">2010</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <span className="text-gray-700">Articles Published</span>
                    <span className="text-gray-900 font-semibold">2,000+</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600">Author Publication Cost</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-xl font-bold text-[#0f2d6b] mb-1">IAAM</div>
                    <div className="text-sm text-gray-600">Membership Access</div>
                  </div>
