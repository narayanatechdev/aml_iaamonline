...
import EthicsProcessStatic from './ethics-process-static';
...
export default async function AboutJournalEthicsProcessPage() {
  ...
  return (
    <EthicsProcessStatic content={cmsPage ? parsePageContent(cmsPage.content) : {}} flat />
  );
}
